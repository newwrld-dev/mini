...
const userName = 'INCONNU-BOY';
const token = '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';
const repoName = 'MINI-INCONNU-XD-DATA';
...
ALIVE: `default`,
FOOTER: '𝗽𝗼𝗽𝗸𝗶𝗱 𝘅𝗺𝗱',
LOGO: `https://files.catbox.moe/kiy0hl.jpg` 
}
...
config.FOOTER = '𝗽𝗼𝗽𝗸𝗶𝗱 𝘅𝗺𝗱'
config.LOGO = `https://files.catbox.moe/kiy0hl.jpg` 
config.ANTI_BAD = []
